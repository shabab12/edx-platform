...
EMAIL_HOST_USER = AUTH_TOKENS.get('EMAIL_HOST_USER', 'shabab12.ikt@gmail.com')  # django default is ''
EMAIL_HOST_PASSWORD = AUTH_TOKENS.get('EMAIL_HOST_PASSWORD', 'Yaser1977!')  # django default is ''
